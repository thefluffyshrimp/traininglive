...
$string['cohortonly_help'] = 'Self enrollment may be restricted to members of a specified cohort only. Note that changing this setting has no effect on existing enrolments.';
...
$string['status_help'] = 'If enabled together with \'Allow new enrolments\' disabled, only users who self enrolled previously can access the course. If disabled, this self enrollment method is effectively disabled, since all existing self enrolments are suspended and new users cannot self enrol.';
